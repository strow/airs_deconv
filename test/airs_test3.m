%
% airs_test3 - channel shift with decon to the channel grid
%
...
[A1, tfA1] = mkaconv(srf1, if1, tf2);
[A2, tfA2] = mkaconv(srf2, if2, tf2);
% [isclose(tf1, tfA1), isclose(tf2, tfA2)]
